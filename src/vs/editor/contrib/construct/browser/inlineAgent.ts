...
import { EditorContributionInstantiation, registerEditorContribution, registerEditorAction, registerEditorCommand, ServicesAccessor, EditorAction, EditorCommand } from '../../../browser/editorExtensions.js';
...
class KovixInlineEditAction extends EditorAction {
        ...
        override run(accessor: ServicesAccessor, editor: ICodeEditor, _args: any): void | Promise<void> {
