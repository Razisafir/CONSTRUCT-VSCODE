...
export class ConstructSessionServiceImpl extends Disposable implements IConstructSessionService {
        ...
        private loadSessionsFromStorage(): IConstructSession[] {
                try {
                        ...
                        return parsed.filter((s: unknown): s is IConstructSession =>
                                typeof s === 'object' && s !== null &&
                                typeof (s as Record<string, unknown>).id === 'string' &&
                                typeof (s as Record<string, unknown>).title === 'string' &&
                                typeof (s as Record<string, unknown>).createdAt === 'number' &&
                                typeof (s as Record<string, unknown>).lastActiveAt === 'number'
                        );
                } catch (error) {
