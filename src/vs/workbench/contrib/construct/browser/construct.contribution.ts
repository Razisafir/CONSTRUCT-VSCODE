...
// NOTE: Flat-namespace memory commands (construct.openMemoryPanel, construct.searchMemories,
// construct.addMemory) have been removed in favor of the nested construct.memory.* commands
// registered in the "Obsidian Memory Commands" section below.
