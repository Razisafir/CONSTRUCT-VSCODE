...
function derived(computeFnOrOwner, computeFn) {
    if (computeFn !== undefined) {
        return new Derived(new debugName_js_1.DebugNameData(computeFnOrOwner, undefined, computeFn), computeFn, undefined, undefined, undefined, deps_js_1.strictEquals);
    }
    return new Derived(new debugName_js_1.DebugNameData(undefined, undefined, computeFnOrOwner), computeFnOrOwner, undefined, undefined, undefined, deps_js_1.strictEquals);
}
function derivedWithSetter(owner, computeFn, setter) {
    return new DerivedWithSetter(new debugName_js_1.DebugNameData(owner, undefined, computeFn), computeFn, undefined, undefined, undefined, deps_js_1.strictEquals, setter);
}
function derivedOpts(options, computeFn) {
    return new Derived(new debugName_js_1.DebugNameData(options.owner, options.debugName, options.debugReferenceFn), computeFn, undefined, undefined, options.onLastObserverRemoved, options.equalsFn ?? deps_js_1.strictEquals);
}
(0, base_js_1._setDerivedOpts)(derivedOpts);
/**
...
function derivedHandleChanges(options, computeFn) {
    return new Derived(new debugName_js_1.DebugNameData(options.owner, options.debugName, undefined), computeFn, options.createEmptyChangeSummary, options.handleChange, undefined, options.equalityComparer ?? deps_js_1.strictEquals);
}
function derivedWithStore(computeFnOrOwner, computeFnOrUndefined) {
    ...
    return new Derived(new debugName_js_1.DebugNameData(owner, undefined, computeFn), r => {
        store.clear();
        return computeFn(r, store);
    }, undefined, undefined, () => store.dispose(), deps_js_1.strictEquals);
}
function derivedDisposable(computeFnOrOwner, computeFnOrUndefined) {
    ...
    }, deps_js_1.strictEquals);
}
class Derived extends base_js_1.BaseObservable {
    _debugNameData;
    _computeFn;
    createChangeSummary;
    _handleChange;
    ...
    constructor(_debugNameData, _computeFn, createChangeSummary, _handleChange, _handleLastObserverRemoved = undefined, _equalityComparator) {
        ...
        (0, logging_js_1.getLogger)()?.handleDerivedCreated(this);
    }
    ...
    get() {
        if (this._isComputing) {
            throw new deps_js_1.BugIndicatingError('Cyclic deriveds are not supported yet!');
        }
    ...
    _recomputeIfNeeded() {
        ...
        try {
            ...
            (0, logging_js_1.getLogger)()?.handleDerivedRecomputed(this, {
                oldValue,
                newValue: this.value,
                change: undefined,
                didChange,
