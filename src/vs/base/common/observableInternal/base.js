...
class TransactionImpl {
    ...
    constructor(_fn, _getDebugName) {
        ...
        (0, logging_js_1.getLogger)()?.handleBeginTransaction(this);
    }
    getDebugName() {
        if (this._getDebugName) {
            return this._getDebugName();
        }
        return (0, debugName_js_1.getFunctionName)(this._fn);
    }
    ...
    finish() {
        ...
        (0, logging_js_1.getLogger)()?.handleEndTransaction();
    }
}
...
function observableValue(nameOrOwner, initialValue) {
    ...
    return new ObservableValue(debugNameData, initialValue, deps_js_1.strictEquals);
}
class ObservableValue extends BaseObservable {
    ...
    set(value, tx, change) {
        ...
        try {
            ...
            (0, logging_js_1.getLogger)()?.handleObservableChanged(this, { oldValue, newValue: value, change, didChange: true, hadValue: true });
...
function disposableObservableValue(nameOrOwner, initialValue) {
    ...
    return new DisposableObservableValue(debugNameData, initialValue, deps_js_1.strictEquals);
}
