...
const platform = __importStar(require("./platform.js"));
const strings_js_1 = require("./strings.js");
const uri_js_1 = require("./uri.js");
const paths = __importStar(require("./path.js"));
var Schemas;
(function (Schemas) {
    /**
    ...
    Schemas.vscodeRemoteResource = 'construct-remote-resource';
    Schemas.vscodeManagedRemoteResource = 'construct-managed-remote-resource';
    Schemas.vscodeUserData = 'construct-userdata';
    Schemas.vscodeCustomEditor = 'construct-custom-editor';
    Schemas.vscodeNotebookCell = 'construct-notebook-cell';
    Schemas.vscodeNotebookCellMetadata = 'construct-notebook-cell-metadata';
    Schemas.vscodeNotebookCellMetadataDiff = 'construct-notebook-cell-metadata-diff';
    Schemas.vscodeNotebookCellOutput = 'construct-notebook-cell-output';
    Schemas.vscodeNotebookCellOutputDiff = 'construct-notebook-cell-output-diff';
    Schemas.vscodeNotebookMetadata = 'construct-notebook-metadata';
    Schemas.vscodeInteractiveInput = 'construct-interactive-input';
    Schemas.vscodeSettings = 'construct-settings';
    Schemas.vscodeWorkspaceTrust = 'construct-workspace-trust';
    Schemas.vscodeTerminal = 'construct-terminal';
    /** Scheme used for code blocks in chat. */
    Schemas.vscodeChatCodeBlock = 'construct-chat-code-block';
    /** Scheme used for LHS of code compare (aka diff) blocks in chat. */
    Schemas.vscodeChatCodeCompareBlock = 'construct-chat-code-compare-block';
    /** Scheme used for the chat input editor. */
    Schemas.vscodeChatSesssion = 'construct-chat-editor';
    /**
     ...
     */
    Schemas.vscodeSourceControl = 'construct-scm';
    /**
...
exports.connectionTokenCookieName = 'construct-tkn';
...
exports.VSCODE_AUTHORITY = 'construct-app';
class FileAccessImpl {
    static FALLBACK_AUTHORITY = exports.VSCODE_AUTHORITY;
    /**
