...
class ConfigKeysIterator {
    ...
    cmp(a) {
        return this._caseSensitive
            ? (0, strings_js_1.compareSubstring)(a, this._value, 0, a.length, this._from, this._to)
            : (0, strings_js_1.compareSubstringIgnoreCase)(a, this._value, 0, a.length, this._from, this._to);
    }
    value() {
...
class UriIterator {
    ...
    cmp(a) {
        if (this._states[this._stateIdx] === 1 /* UriIteratorState.Scheme */) {
            return (0, strings_js_1.compareIgnoreCase)(a, this._value.scheme);
        }
        else if (this._states[this._stateIdx] === 2 /* UriIteratorState.Authority */) {
            return (0, strings_js_1.compareIgnoreCase)(a, this._value.authority);
        }
            ...
            return (0, strings_js_1.compare)(a, this._value.query);
        }
        else if (this._states[this._stateIdx] === 5 /* UriIteratorState.Fragment */) {
            return (0, strings_js_1.compare)(a, this._value.fragment);
        }
        throw new Error();
    }
    value() {
