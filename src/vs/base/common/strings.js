...
class AmbiguousCharacters {
    ...
    static ambiguousCharacterData = new lazy_js_1.Lazy(() => {
    ...
    static cache = new cache_js_1.LRUCachedFunction({ getCacheKey: JSON.stringify }, (locales) => {
    ...
    static _locales = new lazy_js_1.Lazy(() => Object.keys(AmbiguousCharacters.ambiguousCharacterData.value).filter((k) => !k.startsWith('_')));
    static getLocales() {
