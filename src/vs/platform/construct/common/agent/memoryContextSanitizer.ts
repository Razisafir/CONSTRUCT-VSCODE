...
/**
 * @module memoryContextSanitizer
 *
 * Sanitizes memory context before injection into LLM prompts. Use when injecting
 * memory/retrieval results. Strips control characters, truncates long entries,
 * wraps in XML guard tags.
 *
 * (For file-content sanitization with safety delimiters, use
 *  `platform/construct/common/security/promptSanitiser` instead.)
 *
