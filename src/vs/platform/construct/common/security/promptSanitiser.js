...
exports.PromptSanitiser = exports.MAX_CONTEXT_INJECTION_SIZE = void 0;
exports.sanitise = sanitise;
exports.detectInjectionInOutput = detectInjectionInOutput;
exports.truncateForInjection = truncateForInjection;
exports.sanitiseMultiple = sanitiseMultiple;
/**
...
function generateDelimiterId() {
    ...
    return Date.now().toString(36) + generateDelimiterId._counter.toString(36);
}
// SEC-P2: Counter for fallback delimiter generation
(function (generateDelimiterId) {
    // eslint-disable-next-line prefer-const
    generateDelimiterId._counter = 0;
})(generateDelimiterId || (generateDelimiterId = {}));
/**
 ...
 */
function escapeDelimiterPatterns(content, delimiterId) {
 ...
 */
exports.MAX_CONTEXT_INJECTION_SIZE = 10_000;
/**
...
function sanitise(content) {
    ...
    if (filtered.length > exports.MAX_CONTEXT_INJECTION_SIZE) {
        filtered = filtered.substring(0, exports.MAX_CONTEXT_INJECTION_SIZE)
 ...
 */
function truncateForInjection(content, sourceLabel) {
    if (content.length > exports.MAX_CONTEXT_INJECTION_SIZE) {
        const label = sourceLabel ? ` (from ${sourceLabel})` : '';
        return content.substring(0, exports.MAX_CONTEXT_INJECTION_SIZE)
            + `\n[CONTENT TRUNCATED${label} — exceeded ${exports.MAX_CONTEXT_INJECTION_SIZE} characters. Potential injection risk.]`;
    }
    return content;
}
/**
 ...
 */
function sanitiseMultiple(blocks) {
    return blocks
...
class PromptSanitiser {
     ...
     */
    static sanitiseMultiple(blocks) {
        return sanitiseMultiple(blocks);
    }
}
exports.PromptSanitiser = PromptSanitiser;
//# sourceMappingURL=promptSanitiser.js.map