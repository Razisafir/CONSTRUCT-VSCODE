...
function applyDiff(sourceLines, hunks) {
    let conflicts = 0;
...
function applySingleLineAdd(source, lineNumber, content) {
    const result = [...source];
    result.splice(lineNumber, 0, content);
    return result;
}
function applySingleLineDelete(source, lineNumber) {
    const result = [...source];
    result.splice(lineNumber, 1);
    return result;
}
function applySingleLineModify(source, lineNumber, newContent) {
    const result = [...source];
...
//# sourceMappingURL=diffApplication.test.js.map