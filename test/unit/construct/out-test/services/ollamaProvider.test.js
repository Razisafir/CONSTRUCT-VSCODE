 ...
 */
function estimateContextWindow(modelName, parameterSize) {
...
function parseOllamaStatus(responseOk, data) {
    if (!responseOk) {
        return 'unreachable';
    }
...
suite('OllamaProvider', () => {
    ...
    suite('Tool calling — tool calling format', () => {
        ...
        test('tools are converted to Ollama (OpenAI-compatible) format', () => {
            ...
            assert.ok(converted[0].function.name);
...
//# sourceMappingURL=ollamaProvider.test.js.map